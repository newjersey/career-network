...
resource "google_dns_record_set" "a_training" {
  name         = "training.${google_dns_managed_zone.default.dns_name}"
  managed_zone = google_dns_managed_zone.default.name
  type         = "A"
  ttl          = 300
...
resource "google_dns_record_set" "aaaa_training" {
  name         = "training.${google_dns_managed_zone.default.dns_name}"
  managed_zone = google_dns_managed_zone.default.name
  type         = "AAAA"
  ttl          = 300
...
resource "google_dns_record_set" "cname_www_training" {
  name         = "www.training.${google_dns_managed_zone.default.dns_name}"
  managed_zone = google_dns_managed_zone.default.name
  type         = "CNAME"
  ttl          = 3600
...
resource "google_dns_record_set" "txt__training" {
  name         = "training.${google_dns_managed_zone.default.dns_name}"
  managed_zone = google_dns_managed_zone.default.name
  type         = "TXT"
  ttl          = 300
...
resource "google_dns_record_set" "mx_team" {
...
resource "google_dns_record_set" "team_txt" {
  name         = "team.${google_dns_managed_zone.default.dns_name}"
  managed_zone = google_dns_managed_zone.default.name
  type         = "TXT"
  ttl          = 3600
