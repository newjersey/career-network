...
const useStyles = makeStyles(theme => ({
  ...
  alt3: {
    backgroundImage:
      'url(\'data:image/svg+xml;utf8,<svg width="1480" height="324" viewBox="0 0 1480 324" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.5 0.5V323.5C262.686 152.235 415.889 83.8759 725.5 124C999.155 163.808 1163.63 139.819 1480 0.5H0.5Z" fill="white"/></svg>\'), ' +
      'linear-gradient(90deg, #edf0ff 20%, #fefefe 100%)',
    backgroundPosition: 'center -1px, center center',
  },
  alt4: {
    backgroundImage:
      'url(\'data:image/svg+xml;utf8,<svg width="1480" height="226" viewBox="0 0 1480 226" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.5 40.5V226H1206.5C743.152 25.8951 481.458 -54.2645 0.5 40.5Z" fill="white"/></svg>\'), ' +
      'linear-gradient(90deg, #edf0ff 20%, #fefefe 100%)',
    backgroundPosition: 'center bottom, center center',
  },
}));
